...
def build():
    with Context() as ctx:
        ...
        with Location.unknown(ctx):
            ...
            tile_view_32x8 = pto.PartitionTensorViewType.get([32, 8], f32, ctx)
            ...
            tile_buf_32x8 = pto.TileBufType.get([32, 8], f32, vec, [32, 8], cfg, ctx)
            ...
            with InsertionPoint(entry):
                ...
                tv1 = pto.MakeTensorViewOp(tv2_f32, arg1, [c32, c8], [c8, c1]).result
                ...
                sv1 = pto.PartitionViewOp(tile_view_32x8, tv1, offsets=[c0, c0], sizes=[c32, c8]).result

                tb0 = pto.AllocTileOp(tile_buf_32x32).result
                tb1 = pto.AllocTileOp(tile_buf_32x8).result
                tb2 = pto.AllocTileOp(tile_buf_32x32).result

                pto.TLoadOp(None, sv0, tb0)
                pto.TLoadOp(None, sv1, tb1)
                pto.TRowExpandExpdifOp(src0=tb0, src1=tb1, dst=tb2)
